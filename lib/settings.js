...
export const DEFAULT_SETTINGS = {
  ...
  // --- Score de ban : score = force * flex-jeu * meta * niveau * prep * sans-repli ---
  soloBoost: 0.5, // bonus max si le joueur n'a aucun autre champion viable dans
  //                 le role (one-trick). Proportionnel a l'ecart avec son 2e
  //                 choix : repli absent -> +soloBoost ; repli aussi fort -> 0.
  prepBoost: 1.08, // multiplicateur si le champion est "en preparation"
...
export const SETTINGS_SCHEMA = [
  ...
  {
    title: "Score de ban",
    hint: "score = force x flex-jeu x meta x niveau x prep x sans-repli",
    fields: [
      { key: "soloBoost", label: "Bonus sans repli (one-trick)", step: 0.05, min: 0, max: 2 },
