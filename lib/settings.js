...
export const DEFAULT_SETTINGS = {
  ...
  //     wRecent*recent + wWin*winrate + wKda*kda + maitrise) ---
  ...
  // --- Score de ban : score = force * flex-jeu * meta * niveau ---
...
export const SETTINGS_SCHEMA = [
  {
    ...
    hint: "force = confiance x (volume + recent + winrate + KDA + maitrise)",
    fields: [
  ...
  {
    title: "Score de ban",
    hint: "score = force x flex-jeu x meta x niveau",
    fields: [
