...
// Version du format des parties allegees (slimMatch). A incrementer a chaque
// ajout de champ : le chemin de cache change, l'ancien format est ignore et
// l'historique se re-telecharge une fois avec les nouveaux champs.
//  v1 : KDA, role, victoire, file
//  v2 : + teamId, cs, degats aux champions, or, vision, niveau
...
export const cachePaths = {
  ...
  match: (ns, matchId) =>
    path.join(ns, "matches", `${safe(matchId)}.v${MATCH_CACHE_VERSION}.json`),
